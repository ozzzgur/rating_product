...
df = pd.read_csv("python_for_data_science/pythonProject/odevler/pomodoro/Rating Product&SortingReviewsinAmazon/amazon_review.csv")

df["overall"].mean()


df[["helpful",'helpful_yes','helpful_no','total_vote']]
...
def time_based_weighted(df,w1=28,w2=26,w3=24,w4=22):
